...
**Technology | Data Analytics | Cybersecurity | Operations**
...
**Security & Networking:** Wireshark, Nmap, access control, vulnerability management, incident-response concepts  
**Systems & Applications:** Ubuntu/Linux, Node.js, npm, MySQL, technical documentation  
**Operations:** process improvement, data validation, quality control, stakeholder coordination, reporting

## Background
My professional experience includes six years in U.S. Army human-resources and operational support roles, where I worked with high-volume personnel data, reporting, quality control, workflow improvement, training, and senior-leader support.
